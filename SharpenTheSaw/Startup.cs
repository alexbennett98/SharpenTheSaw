...
namespace SharpenTheSaw
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                endpoints.MapControllerRoute("bowlertypepagenum",
               "BowlerType/{bowlertypeid}/{bowlertype}/{pagenum}",
               new { Controller = "Home", action = "Index" });

                endpoints.MapControllerRoute("bowlertypeid",
                    "TeamName/{bowlertypeid}/{bowlertype}",
                    new { Controller = "Home", action = "Index" }
                    );
